...
@Component({
  selector: 'app-tree-draggable',
  templateUrl: './tree-draggable.component.html',
  styleUrls: ['./tree-draggable.component.css']
})

export class TreeDraggableComponent implements OnInit {
  nodes = [ {
    title   : '0-0',
    key     : '00',
    expanded: true,
