...
@Component({
  selector: 'app-table-custom-filter-panel',
  templateUrl: './table-custom-filter-panel.component.html',
  styleUrls: ['./table-custom-filter-panel.component.css']
})
export class TableCustomFilterPanelComponent {
  searchValue = '';
